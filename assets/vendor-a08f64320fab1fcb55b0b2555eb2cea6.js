...
this.get("delay")},willDestroyElement:function(){this._super.apply(this,arguments),o(this.get("timer"))},_countdownToSend:function(){var e=this,t=this.get("sendingIn")
0===t&&(this.set("scheduledToSend",!1),this.get("action")())
var n=i(function(){e.set("sendingIn",t-1e3),e._countdownToSend()},1e3)
this.set("timer",n)},actions:{sendWithDelay:function(){this.set("scheduledToSend",!0)
var e=this.get("delay")
this.set("sendingIn",e?1e3*e:5e3),this._countdownToSend()},cancel:function(){var e=this.get("timer")
e&&(this.set("scheduledToSend",!1),o(e))}}})}),define("ember-cancelable-button/templates/components/cancelable-button",["exports"],function(e){"use strict"
